...
*See [[overview]] for a map of all the directory nodes grouped by purpose.*

![Graph view of the vault: every directory and concept node linked together](graph.png)
